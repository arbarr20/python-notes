...
# Ejemplo de uso
#
# Este ejemplo requiere que realice estos pasos de configuración:
#
# 1. Vaya a run / foo y ejecute logsim.py
# 2. Vaya a run / bar y ejecute logsim.py
#
# Estos dos pasos comenzarán a escribir dos archivos de registro de Apache diferentes.
# Ahora, vamos a leer de ambos al mismo tiempo.

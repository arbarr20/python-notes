# cobroadcast.py
#
# Un ejemplo de transmisión de un flujo de datos a múltiples objetivos de Corrutinas.
...
if __name__ == '__main__':
    f = open("access-log")
    destinos = [grep('python', printer()),grep('ply', printer()),grep('swig',printer())]
    follow(f,broadcast(destinos))
